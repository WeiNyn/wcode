...
| 28 | Plan mode: explore + plan, don't mutate until approved (see [plan-mode.md](plan-mode.md)) | ◐ P1–P2 shipped (mode/prompt/hook/bash-gate/`/plan`/chip + todo persistence & seed); P3 (`/verify`) open |
