...
| 8 | Unified interface & protocol — TUI + multi-agent (see [`interface-protocol-brainstorm.md`](interface-protocol-brainstorm.md)) | ◐ S0–S2 landed; S3 TUI P0–P3d; S4-1/2/3/5 landed; S4-4 outbound landed (reply path next) |
