...
impl AgentMessage {
    ...
    /// A synthetic user message carrying a compaction summary that stands in
    /// for the summarized prefix of the conversation.
    pub fn summary(text: impl Into<String>) -> AgentMessage {
        AgentMessage::User {
